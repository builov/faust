...
/* harmony export */ });
/* harmony import */ var _Fetcher_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Fetcher.js */ "./assets/js/Fetcher.js");
/* harmony import */ var _MetaData_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MetaData.js */ "./assets/js/MetaData.js");
/* harmony import */ var _TableManager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TableManager.js */ "./assets/js/TableManager.js");
/* harmony import */ var _ButtonToggleManager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ButtonToggleManager.js */ "./assets/js/ButtonToggleManager.js");
/* harmony import */ var _InlineCommentController_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./InlineCommentController.js */ "./assets/js/InlineCommentController.js");
/* harmony import */ var _Loader_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Loader.js */ "./assets/js/Loader.js");
...
var _tableManager = /*#__PURE__*/new WeakMap();
var _buttonToggleManager = /*#__PURE__*/new WeakMap();
var _dialogController = /*#__PURE__*/new WeakMap();
var _columnLoader = /*#__PURE__*/new WeakMap();
var _App_brand = /*#__PURE__*/new WeakSet();
var App = /*#__PURE__*/function () {
  function App() {
    var _this = this;
    _classCallCheck(this, App);
    // ---------- КОНТЕКСТНОЕ МЕНЮ ПЕРЕВОДОВ ----------
    _classPrivateMethodInitSpec(this, _App_brand);
    _classPrivateFieldInitSpec(this, _metaData, void 0);
    _classPrivateFieldInitSpec(this, _fetcher, void 0);
    _classPrivateFieldInitSpec(this, _tableManager, void 0);
    _classPrivateFieldInitSpec(this, _buttonToggleManager, void 0);
    _classPrivateFieldInitSpec(this, _dialogController, void 0);
    _classPrivateFieldInitSpec(this, _columnLoader, void 0);
    // Блокируем интерфейс до завершения init
    // document.body.classList.add('app-loading'); перенесено в html-код

    _classPrivateFieldSet(_columnLoader, this, new _Loader_js__WEBPACK_IMPORTED_MODULE_5__.Loader());
    // Если в HTML есть готовый контейнер, можно передать:
    // this.#loader = new Loader(document.getElementById('loading-indicator'));

    var rawMeta = JSON.parse(document.getElementById('meta-data').textContent);
    _classPrivateFieldSet(_metaData, this, new _MetaData_js__WEBPACK_IMPORTED_MODULE_1__.MetaData(rawMeta));
    _classPrivateFieldSet(_fetcher, this, new _Fetcher_js__WEBPACK_IMPORTED_MODULE_0__.Fetcher());
    var mainContainer = document.querySelector('.main-container');

    // Создаём менеджеры, зависящие от метаданных и DOM
    _classPrivateFieldSet(_tableManager, this, new _TableManager_js__WEBPACK_IMPORTED_MODULE_2__.TableManager(mainContainer, _classPrivateFieldGet(_metaData, this), {
      onContentUpdated: function onContentUpdated() {
        return _this.initDynamicDialogs();
      }
    }));
    _classPrivateFieldSet(_buttonToggleManager, this, new _ButtonToggleManager_js__WEBPACK_IMPORTED_MODULE_3__.ButtonToggleManager(_classPrivateFieldGet(_tableManager, this)));
    _classPrivateFieldSet(_dialogController, this, new _InlineCommentController_js__WEBPACK_IMPORTED_MODULE_4__.InlineCommentController(mainContainer));
    _assertClassBrand(_App_brand, this, _initContextMenu).call(this);

    // Инициализация кнопки «наверх»
    new _ScrollToTopButton_js__WEBPACK_IMPORTED_MODULE_6__.ScrollToTopButton();
  }
  return _createClass(App, [{
    key: "init",
    value: function init() {
      console.log('app init start');
      _assertClassBrand(_App_brand, this, _initFilterButtons).call(this);
      _assertClassBrand(_App_brand, this, _initNavLinks).call(this);
    ...
    key: "initDynamicDialogs",
    value: function initDynamicDialogs() {
      // Находим комментарии и передаем их в контроллер, чтобы он сгенерировал для них кнопки "*"
      _classPrivateFieldGet(_dialogController, this).init(document.querySelectorAll('.main-container dialog'));
    }
  }]);
}();
...
function _showContextMenu(lineNum, x, y, td) {
  var _this3 = this;
  var items = [{
    label: 'Перевести строку',
    action: function action() {
      return _assertClassBrand(_App_brand, _this3, _handleTranslation).call(_this3, lineNum, 'line', x, y, td);
    }
  }, {
    label: 'Перевести строфу',
    action: function action() {
      return _assertClassBrand(_App_brand, _this3, _handleTranslation).call(_this3, lineNum, 'stanza', x, y, td);
    }
  }, {
    label: 'Перевести реплику',
    action: function action() {
      return _assertClassBrand(_App_brand, _this3, _handleTranslation).call(_this3, lineNum, 'speech', x, y, td);
    }
  }
...
function _handleTranslation(lineNum, type, x, y, td) {
  ...
  var ids = _assertClassBrand(_App_brand, this, _getRelatedlineNums).call(this, lineNum, type);
                  ...
                  return _regenerator().w(function (_context3) {
                    while (1) switch (_context3.p = _context3.n) {
                      ...
                      case 1:
                        ...
                        Object.entries(texts).forEach(function (_ref3) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            return _context.a(2);
          case 1:
            id = btn.dataset.id; // Если колонка уже есть — удаляем
            if (!_classPrivateFieldGet(_tableManager, _this4).hasColumn(id)) {
              _context.n = 3;
              break;
            }
            _classPrivateFieldGet(_columnLoader, _this4).show();
            _context.n = 2;
            return new Promise(function (resolve) {
              return setTimeout(resolve, 0);
            });
          case 2:
            _classPrivateFieldGet(_tableManager, _this4).removeColumn(id);
            _classPrivateFieldGet(_buttonToggleManager, _this4).syncButtonState(btn, id);
            _classPrivateFieldGet(_columnLoader, _this4).hide();
            return _context.a(2);
          case 3:
            _context.p = 3;
            _classPrivateFieldGet(_columnLoader, _this4).show();
 ...
 * @returns {string[]}
 */
function _getRelatedlineNums(lineNum, type) {
  if (type === 'line') {
    return [lineNum];
  }
  ...
  var startRow = table.querySelector("tr[data-num=\"".concat(lineNum, "\"]"));
  if (!startRow) {
    return [lineNum];
  }
  ...
  var beginRow = table.rows[0];
  var current = startRow.previousElementSibling;
  while (current) {
  ...
  var endRow = table.rows[table.rows.length - 1];
...
/***/ "./assets/js/ButtonToggleManager.js"
/*!******************************************!*\
  !*** ./assets/js/ButtonToggleManager.js ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ButtonToggleManager: () => (/* binding */ ButtonToggleManager)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
function _assertClassBrand(e, t, n) { if ("function" == typeof e ? e === t : e.has(t)) return arguments.length < 3 ? t : n; throw new TypeError("Private element is not present on this object"); }
var _tableManager = /*#__PURE__*/new WeakMap();
var ButtonToggleManager = /*#__PURE__*/function () {
  function ButtonToggleManager(tableManager) {
    _classCallCheck(this, ButtonToggleManager);
    _classPrivateFieldInitSpec(this, _tableManager, void 0);
    _classPrivateFieldSet(_tableManager, this, tableManager);
  }
  return _createClass(ButtonToggleManager, [{
    key: "syncButtonState",
    value: function syncButtonState(button, textId) {
      var isActive = _classPrivateFieldGet(_tableManager, this).hasColumn(textId);
      if (isActive) {
...
var _onHide = /*#__PURE__*/new WeakMap();
var _handleOutsideClick = /*#__PURE__*/new WeakMap();
// ContextMenu.js
var ContextMenu = /*#__PURE__*/function () {
  ...
  function ContextMenu(_ref) {
    ...
    _classPrivateFieldInitSpec(this, _onHide, null);
    _classPrivateFieldInitSpec(this, _handleOutsideClick, function (e) {
      if (_classPrivateFieldGet(_element, _this) && !_classPrivateFieldGet(_element, _this).contains(e.target)) {
        _this.hide();
      }
    });
  ...
  return _createClass(ContextMenu, [{
    ...
    value: function show() {
      ...
      setTimeout(function () {
        document.addEventListener('click', _classPrivateFieldGet(_handleOutsideClick, _this2), {
          capture: true
        });
    ...
    value: function hide() {
      ...
      if (_classPrivateFieldGet(_element, this)) {
        _classPrivateFieldGet(_element, this).remove();
        _classPrivateFieldSet(_element, this, null);
      }
      document.removeEventListener('click', _classPrivateFieldGet(_handleOutsideClick, this), {
        capture: true
      });
      ...
      (_classPrivateFieldGet2 = _classPrivateFieldGet(_onHide, this)) === null || _classPrivateFieldGet2 === void 0 || _classPrivateFieldGet2.call(this);
    }
  }]);
}();
var _current = {
...
function _checkPrivateRedeclaration(e, t) { if (t.has(e)) throw new TypeError("Cannot initialize the same private elements twice on an object"); }
function _assertClassBrand(e, t, n) { if ("function" == typeof e ? e === t : e.has(t)) return arguments.length < 3 ? t : n; throw new TypeError("Private element is not present on this object"); }
var _Fetcher_brand = /*#__PURE__*/new WeakSet();
var Fetcher = /*#__PURE__*/function () {
  function Fetcher() {
    ...
    _classPrivateMethodInitSpec(this, _Fetcher_brand);
  }
  return _createClass(Fetcher, [{
    key: "getJson",
    value: function () {
      var _getJson = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(url) {
        var finalUrl, response;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              // console.log('url: ', url);
              finalUrl = _assertClassBrand(_Fetcher_brand, this, _prepareUrl).call(this, url); // console.log('finalUrl: ', finalUrl);
              _context.n = 1;
    ...
    key: "postJson",
    value: function () {
      var _postJson = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(url, body) {
        var finalUrl, response;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              finalUrl = _assertClassBrand(_Fetcher_brand, this, _prepareUrl).call(this, url);
              _context2.n = 1;
              return fetch(finalUrl, {
                method: 'POST',
                headers: {
...
function _prepareUrl(url) {
  ...
  var _iterator = _createForOfIteratorHelper(currentParams.entries()),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
...
/***/ "./assets/js/InlineCommentController.js"
/*!**********************************************!*\
  !*** ./assets/js/InlineCommentController.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   InlineCommentController: () => (/* binding */ InlineCommentController)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
function _checkPrivateRedeclaration(e, t) { if (t.has(e)) throw new TypeError("Cannot initialize the same private elements twice on an object"); }
function _assertClassBrand(e, t, n) { if ("function" == typeof e ? e === t : e.has(t)) return arguments.length < 3 ? t : n; throw new TypeError("Private element is not present on this object"); }
var _InlineCommentController_brand = /*#__PURE__*/new WeakSet();
var InlineCommentController = /*#__PURE__*/function () {
  function InlineCommentController() {
    _classCallCheck(this, InlineCommentController);
    /** Создает кнопку "*" перед диалогом, если её там ещё нет */
    _classPrivateMethodInitSpec(this, _InlineCommentController_brand);
    _assertClassBrand(_InlineCommentController_brand, this, _initGlobalListeners).call(this);
  }

  /** Создает триггеры "*" перед диалогами. Безопасно вызывать повторно для новых элементов из XHR. */
  return _createClass(InlineCommentController, [{
    key: "init",
    value: function init(commentElements) {
      var _this = this;
      commentElements.forEach(function (comment) {
        return _assertClassBrand(_InlineCommentController_brand, _this, _setupCommentTrigger).call(_this, comment);
      });
    }
  }]);
}();
function _setupCommentTrigger(comment) {
  // Защита от дублирования: проверяем, не создана ли кнопка ранее
  var prevElement = comment.previousElementSibling;
...
function _initGlobalListeners() {
  ...
  document.addEventListener('click', function (e) {
    ...
    var trigger = target.closest('.comment-trigger');
    if (trigger) {
      e.stopPropagation();
      var comment = trigger.nextElementSibling;
      if (comment && comment.tagName === 'DIALOG') {
        _assertClassBrand(_InlineCommentController_brand, _this2, _toggleComment).call(_this2, comment);
      }
      return;
    }

    // 2. Клик по кнопке закрытия "×" внутри диалога
    var closeBtn = target.closest('.inline-comment-close');
    if (closeBtn) {
      e.stopPropagation();
      var _comment = closeBtn.closest('dialog');
      if (_comment) _comment.close();
      return;
    }

    // 3. Клик внутри тела самого диалога (чтобы он не закрывался при клике на свой контент)
    var insideComment = target.closest('dialog');
    if (insideComment) {
      e.stopPropagation();
      return;
    }
    ...
    _assertClassBrand(_InlineCommentController_brand, _this2, _closeAllComments).call(_this2);
  });

  // Глобальный перехват события закрытия (capture: true, т.к. событие 'close' не всплывает)
  document.addEventListener('close', function (e) {
    if (e.target.tagName === 'DIALOG') {
      _assertClassBrand(_InlineCommentController_brand, _this2, _removeCloseButton).call(_this2, e.target);
    }
  }, true);
}
function _toggleComment(comment) {
  // Закрыть все остальные открытые диалоги
  document.querySelectorAll('dialog[open]').forEach(function (d) {
    if (d !== comment) d.close();
  });
  if (!comment.open) {
    _assertClassBrand(_InlineCommentController_brand, this, _openWithCloseButton).call(this, comment);
  } else {
    comment.close();
  }
}
function _openWithCloseButton(comment) {
...
function _removeCloseButton(comment) {
  var closeBtn = comment.querySelector('.inline-comment-close');
  if (closeBtn) closeBtn.remove();
}
function _closeAllComments() {
  document.querySelectorAll('dialog[open]').forEach(function (d) {
    return d.close();
  });
}
...
function _assertClassBrand(e, t, n) { if ("function" == typeof e ? e === t : e.has(t)) return arguments.length < 3 ? t : n; throw new TypeError("Private element is not present on this object"); }
var _element = /*#__PURE__*/new WeakMap();
var _Loader_brand = /*#__PURE__*/new WeakSet();
// Loader.js
var Loader = /*#__PURE__*/function () {
  ...
  function Loader() {
    ...
    if (element) {
      ...
      _classPrivateFieldSet(_element, this, _assertClassBrand(_Loader_brand, this, _createOverlay).call(this));
      document.body.appendChild(_classPrivateFieldGet(_element, this));
    }
  }
  return _createClass(Loader, [{
    ...
    value: function show() {
      var _classPrivateFieldGet2;
      (_classPrivateFieldGet2 = _classPrivateFieldGet(_element, this)) === null || _classPrivateFieldGet2 === void 0 || _classPrivateFieldGet2.classList.remove('d-none'); // или убрать скрывающий класс
    ...
    value: function hide() {
      ...
      (_classPrivateFieldGet3 = _classPrivateFieldGet(_element, this)) === null || _classPrivateFieldGet3 === void 0 || _classPrivateFieldGet3.classList.add('d-none');
...
var MetaData = /*#__PURE__*/function () {
  ...
  return _createClass(MetaData, [{
    key: "getTitle",
    value: function getTitle(textId) {
      var _classPrivateFieldGet2, _classPrivateFieldGet3;
      return (_classPrivateFieldGet2 = (_classPrivateFieldGet3 = _classPrivateFieldGet(_data, this)[textId]) === null || _classPrivateFieldGet3 === void 0 ? void 0 : _classPrivateFieldGet3.title) !== null && _classPrivateFieldGet2 !== void 0 ? _classPrivateFieldGet2 : '';
    }
  }, {
    key: "getStartsFrom",
    ...
    key: "getRelatedlineNums",
    value: function getRelatedlineNums(lineNum, type) {
...
/***/ "./assets/js/ScrollToTopButton.js"
/*!****************************************!*\
  !*** ./assets/js/ScrollToTopButton.js ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var _ScrollToTopButton_brand = /*#__PURE__*/new WeakSet();
// ScrollToTopButton.js
var ScrollToTopButton = /*#__PURE__*/_createClass(
// показывать после прокрутки на 300px

function ScrollToTopButton() {
  var _this = this;
  _classCallCheck(this, ScrollToTopButton);
  _classPrivateMethodInitSpec(this, _ScrollToTopButton_brand);
  _classPrivateFieldInitSpec(this, _button, void 0);
  _classPrivateFieldInitSpec(this, _threshold, 300);
  _classPrivateFieldSet(_button, this, document.createElement('button'));
  _classPrivateFieldGet(_button, this).className = 'scroll-to-top';
  _classPrivateFieldGet(_button, this).innerHTML = '↑';
  _classPrivateFieldGet(_button, this).setAttribute('aria-label', 'Прокрутить наверх');
  document.body.appendChild(_classPrivateFieldGet(_button, this));
  _classPrivateFieldGet(_button, this).addEventListener('click', function () {
    return _assertClassBrand(_ScrollToTopButton_brand, _this, _scrollToTop).call(_this);
  });
  window.addEventListener('scroll', function () {
    return _assertClassBrand(_ScrollToTopButton_brand, _this, _onScroll).call(_this);
  }, {
    passive: true
  });
});
function _onScroll() {
  if (window.scrollY > _classPrivateFieldGet(_threshold, this)) {
    _classPrivateFieldGet(_button, this).classList.add('is-visible');
  } else {
    _classPrivateFieldGet(_button, this).classList.remove('is-visible');
  }
}
...
var _metaData = /*#__PURE__*/new WeakMap();
var _onContentUpdated = /*#__PURE__*/new WeakMap();
var _TableManager_brand = /*#__PURE__*/new WeakSet();
var TableManager = /*#__PURE__*/function () {
  function TableManager(tableElement, metaData, options) {
    _classCallCheck(this, TableManager);
    // Приватные детали реализации
    _classPrivateMethodInitSpec(this, _TableManager_brand);
    _classPrivateFieldInitSpec(this, _table, void 0);
    _classPrivateFieldInitSpec(this, _metaData, void 0);
    _classPrivateFieldInitSpec(this, _onContentUpdated, void 0);
    _classPrivateFieldSet(_table, this, tableElement);
    _classPrivateFieldSet(_metaData, this, metaData);
    _classPrivateFieldSet(_onContentUpdated, this, options.onContentUpdated || function () {});
  }
  return _createClass(TableManager, [{
    key: "element",
    get: function get() {
      return _classPrivateFieldGet(_table, this);
    }

    // Публичные методы для внешнего управления
  }, {
    key: "addColumn",
    value: function addColumn(id, jsonData) {
      _assertClassBrand(_TableManager_brand, this, _disableRender).call(this);
      _assertClassBrand(_TableManager_brand, this, _insertDataCells).call(this, id, jsonData);
      _assertClassBrand(_TableManager_brand, this, _createHeaderCell).call(this, id);
      _assertClassBrand(_TableManager_brand, this, _enableRender).call(this);
      _assertClassBrand(_TableManager_brand, this, _setColumnTitle).call(this, id);
      _classPrivateFieldGet(_onContentUpdated, this).call(this);
    }
    ...
    value: function removeColumn(id) {
      var headerCell = _classPrivateFieldGet(_table, this).querySelector("th[data-text-id=\"".concat(id, "\"]"));
      if (!headerCell) return;
      var colIndex = headerCell.cellIndex;
      var parent = _classPrivateFieldGet(_table, this).parentNode;

      // 1. Временно убираем таблицу из документа
      var placeholder = document.createComment('table-placeholder');
      parent.replaceChild(placeholder, _classPrivateFieldGet(_table, this));

      // 2. Работаем с уже "оторванной" таблицей — быстро
      var _iterator = _createForOfIteratorHelper(_classPrivateFieldGet(_table, this).rows),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var row = _step.value;
      ...
      parent.replaceChild(_classPrivateFieldGet(_table, this), placeholder);
    }
  }, {
    key: "hasColumn",
...
function _disableRender() {
  _classPrivateFieldGet(_table, this).style.display = 'none';
}
function _enableRender() {
  _classPrivateFieldGet(_table, this).style.display = '';
}
...
function _createHeaderCell(id) {
  var theadRow = _classPrivateFieldGet(_table, this).tHead.rows[0];
  var headerCell = document.createElement('th');
  headerCell.dataset.textId = id;
  theadRow.appendChild(headerCell);
}
function _setColumnTitle(id) {
  var headerCell = _classPrivateFieldGet(_table, this).querySelector("th[data-text-id=\"".concat(id, "\"]"));
  if (!headerCell) return;
  var title = _classPrivateFieldGet(_metaData, this).getTitle(id);
...
/* harmony import */ var _css_style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../css/style.scss */ "./assets/css/style.scss");
/* harmony import */ var _App_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./App.js */ "./assets/js/App.js");



document.addEventListener('DOMContentLoaded', function () {
  var app = new _App_js__WEBPACK_IMPORTED_MODULE_2__.App();
  app.init();
});
})();
